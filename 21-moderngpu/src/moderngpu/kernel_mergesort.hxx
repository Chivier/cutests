...
template<typename launch_arg_t = empty_t, typename key_t, typename val_t,
  typename comp_t>
void launchboundsort(key_t* keys_input, val_t* vals_input, int count,
  comp_t comp, context_t& context) {
...
// Key-only mergesort
template<typename launch_arg_t = empty_t, typename key_t, typename comp_t>
void launchboundsort(key_t* keys_input, int count, comp_t comp, 
  context_t& context) {

  launchboundsort<launch_arg_t>(keys_input, (empty_t*)nullptr, count, comp, 
    context);
}
